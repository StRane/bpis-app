  ...
  return (
    <>
      ...
      <main>
        ...
        <div className="m-4 col-start-1 col-span-12 text-left text-lg text-bpisgry font-light grid grid-cols-3 xl:grid-cols-4 gap-9">
          <NavigationHelper name="Contact Us" />
          <div className="col-span-3">
            <p>You can reach us from adresses given below</p>
            <ul>
              <li className="li">
                <HiPhone className="inline-block mr-2" />
                ADMIN OFFICE: (+66) 038-411-236
              </li>
              <li className="li">
                <HiPhone className="inline-block mr-2" />
                FINANCE OFFICE: (+66) 038-411-235
              </li>
              <li className="group">
                <HiMail className="inline-block mr-2 group-hover:fill-bpisg" />
                <Link href="mailto:theprincipal.bpis@gmail.com">
                  <p className="inline-block group-hover:text-bpisg">
                    theprincipal.bpis@gmail.com
                  </p>
                </Link>
              </li>
              <li className="group">
                ...
                >
                  <a target="_blank" aria-label="bpis facebook page">
                    <svg
                      ...
                      viewBox="0 0 24 24"
                      className="w-5 h-5 mr-2 fill-current group-hover:fill-bpisg inline-block"
                    >
            ...
            <iframe
              className="w-full min-h-[50vh] col-span-3"
              loading="lazy"
              src="https://www.google.com/maps/embed/v1/place?q=place_id:ChIJmwccS9qVAjER5kYF4XpjqxU&key=AIzaSyDPLcqZ9GLMtuKYLezgTNZzWm1KvuxB-Jc"
            />
          </div>
          <SideInfos />
        </div>
